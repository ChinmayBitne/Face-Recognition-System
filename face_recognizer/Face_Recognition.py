...
lbl = tk.Label(window, text = "Roll No.",
...
takeImg = tk.Button(window, text ="Add database",
command = TakeImages, fg ="white", bg ="blue",
width = 20, height = 3, activebackground = "Red",
font =('times', 15, ' bold '))
takeImg.place(x = 200, y = 500)
trainImg = tk.Button(window, text ="Train Faces",
command = TrainImages, fg ="white", bg ="blue",
width = 20, height = 3, activebackground = "Red",
font =('times', 15, ' bold '))
trainImg.place(x = 500, y = 500)
trackImg = tk.Button(window, text ="Recognize Face",
command = TrackImages, fg ="white", bg ="blue",
width = 20, height = 3, activebackground = "Red",
font =('times', 15, ' bold '))
